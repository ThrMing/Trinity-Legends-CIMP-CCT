public class PriestCards extends GenerateCard
{
	/* Default constructor
	   - Created by Brian -
	 */
	...
	{
		int attackVal = super.GenRandomVal (5, 15);
		int manaUsed;
	...
	{
		int healingVal = super.GenRandomVal (5,20) * 2;
		int manaUsed;
	...
	{
		int manaRegenVal = super.GenRandomVal (5,25) * 2;
		int manaUsed;
